...
def get_k_slice(energy, psi, r, l_max, m_max, potential, target, plane='xy', d_phi = 0.001):
...
angle = []
data = []
for idx in np.arange(-1,-f["/Wavefunction/time"][:].shape[0],-1):
    f = h5py.File("TDSE.h5", "r")
...
np.savetxt("xy_1_photon.txt",angle)
fig = plt.figure(figsize=(12, 9), dpi=80)
plt.title("xy_1_photon")
d_ang = 0.001
