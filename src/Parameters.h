...
class Parameters : protected Utils
{
 private:
  ...
  PetscInt
      write_frequency_checkpoint;       /* how many steps between checkpoints during
                                       propagation */
  PetscInt write_frequency_observables; /* how many steps between observable
                                      measurements during propagation */
  PetscInt
      write_frequency_eigin_state; /* how many steps between checkpoints during
  ...
  PetscInt free_propagate; /* How many free propagation steps (-1 means
